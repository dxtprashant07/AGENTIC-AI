class PlanAgent:
    ...
    def analyze_query(self, query):
        ...
        # Decompose travel-related queries
        if 'trip' in query.lower() and 'itinerary' in query.lower():
            tasks.append("Plan a 3-day itinerary for Manali")
            tasks.append("Suggest budget hotels in Manali")
            tasks.append("Calculate total cost under ₹15,000")
            return tasks
